...
This is an android (iOS not tested, but may work) food finder app (similar to barebones Uber Eats). This project queries user's location to determine distance from venues real time. Venues displayed are fixed and scope is limited to select locations around University of Washington, Seattle.
